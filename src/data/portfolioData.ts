...
export const PROFILE_DATA: ProfileInfo = {
  name: 'Dwip Halder',
  education: 'B.A English Honours',
  year: '1st Year',
  qualifications: [
    'Secondary (Madhyamik) Completed',
    'Higher Secondary Completed',
    'Computer Diploma Completed'
  ],
  profession: ['Freelancer', 'Developer', 'AI Specialist'],
  location: 'West Bengal, India',
  email: 'dwiphalder49@gmail.com',
...
export const TRANSLATIONS = {
  EN: {
    ...
    heroRole: 'College Student • AI Freelancer • Developer',
    heroDesc: 'I build modern Android applications, intelligent AI-powered solutions, responsive websites, and automation tools. Passionate about learning new technologies and turning creative ideas into real digital products.',
    viewProjects: 'View My Projects',
    hireMe: 'Hire Me',
    whoAmI: 'Who Am I?',
    aboutText1: 'My name is Dwip Halder. I am currently pursuing B.A. English Honours (1st Year). I have successfully completed both Secondary (Madhyamik) and Higher Secondary education. I also hold a Computer Diploma.',
    aboutText2: 'I specialize in AI-assisted software development, Android application development, website development, UI design, and modern web technologies. I enjoy solving problems and continuously learning new skills to build useful digital experiences.',
    mySkills: 'Skills & Expertise',
    myServices: 'My Specialized Services',
    myEducation: 'Education Timeline',
    featuredProjects: 'Featured Projects',
    whyChooseMeTitle: 'Why Choose Me',
    contactTitle: "Let's Build Something Amazing Together",
    contactSubtitle: 'Available for freelance projects, Android APK creation, web development, and AI consulting.',
  ...
  BN: {
    ...
    heroRole: 'কলেজ ছাত্র • AI ফ্রিল্যান্সার • ডেভেলপার',
    heroDesc: 'আমি আধুনিক অ্যান্ড্রয়েড অ্যাপ্লিকেশন, বুদ্ধিমান AI ভিত্তিক সমাধান, রেসপন্সিভ ওয়েবসাইট এবং অটোমেশন টুল তৈরি করি। নতুন প্রযুক্তি শিখতে এবং সৃজনশীল ধারণা বাস্তব পণ্যে রূপান্তর করতে আমি আগ্রহী।',
    viewProjects: 'আমার প্রজেক্টগুলো দেখুন',
    hireMe: 'আমাকে হায়ার করুন',
    whoAmI: 'আমি কে?',
    aboutText1: 'আমার নাম দ্বীপ হালদার। আমি বর্তমানে বি.এ. ইংলিশ অনার্স (১ম বর্ষ) পড়াশোনা করছি। আমি মাধ্যমিক এবং উচ্চ মাধ্যমিক উভয় শিক্ষাই সফলভাবে সম্পন্ন করেছি। আমার একটি কম্পিউটার ডিপ্লোমাও রয়েছে।',
    aboutText2: 'আমি AI-সহায়ক সফটওয়্যার ডেভেলপমেন্ট, অ্যান্ড্রয়েড অ্যাপ ডেভেলপমেন্ট, ওয়েবসাইট ডেভেলপমেন্ট, UI ডিজাইন এবং আধুনিক ওয়েব প্রযুক্তিতে বিশেষজ্ঞ।',
    mySkills: 'দক্ষতা এবং পারদর্শিতা',
    myServices: 'আমার বিশেষ সেবাসমূহ',
    myEducation: 'শিক্ষাগত যোগ্যতা',
    featuredProjects: 'প্রধান প্রজেক্টসমূহ',
    whyChooseMeTitle: 'কেন আমাকে বেছে নেবেন',
    contactTitle: 'চলুন একসাথে চমৎকার কিছু তৈরি করি',
    contactSubtitle: 'ফ্রিল্যান্স প্রজেক্ট, অ্যান্ড্রয়েড APK তৈরি, ওয়েব ডেভেলপমেন্ট এবং AI কনসাল্টিং-এর জন্য যোগাযোগ করুন।',
